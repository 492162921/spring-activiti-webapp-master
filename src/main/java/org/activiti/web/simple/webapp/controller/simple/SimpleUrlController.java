 ...
 * 详见spring-mvc-servlet.xml中 <bean class="org.springframework.web.servlet.handler.SimpleUrlHandlerMapping">
 * 中<prop key="/SimpleUrl">SimpleUrlController</prop>的配置
 * 下面各方法的请求路径为
 * /simpleUrl/jsp
 * /simpleUrl/velocity
...
public class SimpleUrlController {
	...
	/**
	 * 从地址栏接受参数  /simpleUrl/showUser/admin/admin name为admin pwd为admin 请求转发到showuser.jsp
	 * @param username
	 * @param password
	 * @param map
	 * @return
